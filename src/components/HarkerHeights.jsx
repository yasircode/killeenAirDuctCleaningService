    ...
    <div style={styles.container}>
      ...
      <header style={styles.hero}>
        <div style={{maxWidth: '900px', margin: '0 auto'}}>
          <h1 style={styles.h1}>Air Duct Cleaning in Harker Heights, TX | Killeen Air Duct Cleaners</h1>
      ...
      <section style={styles.section}>
        <p>
          The <strong>Texas heat</strong> is relentless, and your AC works overtime to keep you cool. In Harker Heights, this heavy usage leads to a rapid buildup of <strong>dust, allergens, and debris</strong> within your ventilation system. At Killeen Air Duct Cleaners, we focus on maximizing your home’s <strong>energy efficiency</strong> and ensuring the air your family breathes is clean and safe.
        </p>
      </section>

      {/* AIR DUCT CLEANING SECTION */}
      <section style={styles.section}>
        <h2 style={styles.h2}>Air Duct Cleaning in Harker Heights, TX</h2>
        <p>Our comprehensive <strong>duct cleaning Harker Heights TX</strong> service ensures every corner of your system is addressed. We don't just vacuum vents; we perform a deep medical-grade cleaning.</p>
        <div style={styles.grid}>
          ...
          <div style={styles.card}>
            <strong>Improved Airflow:</strong> Professional <strong>vent cleaning Harker Heights</strong> removes blockages, allowing your HVAC to breathe easier.
          </div>
        </div>
      </section>
      ...
      <section style={styles.section}>
        <h2 style={styles.h2}>HVAC System Cleaning in Harker Heights, TX</h2>
        <p>To target higher efficiency and bigger energy savings, our <strong>HVAC cleaning Harker Heights TX</strong> includes the internal components that most cleaners skip.</p>
        <div style={styles.grid}>
          ...
          <ul style={{paddingLeft: '20px'}}>
            ...
            <li><strong>Prevent Breakdowns:</strong> Reduce <strong>AC system cleaning Harker Heights</strong> emergency calls.</li>
          </ul>
        </div>
      </section>
      ...
      <section style={styles.section}>
        <div style={styles.grid}>
          <div>
            ...
            <p>Lint is a major fire hazard. Our Harker Heights team provides expert lint removal for faster drying times and <strong>fire hazard prevention</strong>.</p>
          </div>
          <div>
            <h2 style={styles.h2}>Chimney Sweep</h2>
            <p>Prepare for the cooler months with our <strong>creosote removal</strong> and fireplace inspection services in Harker Heights, TX.</p>
          </div>
        </div>
      </section>
      ...
      <section style={styles.section}>
        <h2 style={styles.h2}>Air Duct Replacement in Harker Heights, TX</h2>
        <p>Sometimes cleaning isn't enough. If you have <strong>new ductwork Harker Heights</strong> needs, we provide high-ticket replacement services for:</p>
        <ul>
      ...
      <section style={styles.section}>
        <h2 style={styles.h2}>Attic Insulation Services in Harker Heights, TX</h2>
        <p>In Texas, your attic can reach 150°F. Our <strong>attic insulation Harker Heights TX</strong> services include blown-in insulation that acts as a thermal shield, drastically reducing the strain on your HVAC system.</p>
      </section>

      {/* CTA SECTION */}
      <div style={styles.ctaBox}>
        <h2 style={{color: 'white', border: 'none', padding: '0'}}>Get a Free Estimate in Harker Heights, TX</h2>
      ...
      <section style={{...styles.section, ...styles.faqContainer}}>
        ...
        <div style={styles.faqItem}>
          ...
          <p>Absolutely. Proper <strong>blown-in insulation Harker Heights</strong> can lower your cooling costs by up to 20% by preventing heat transfer from the attic into your living space.</p>
        </div>
        <div style={styles.faqItem}>
      ...
      <footer style={{textAlign: 'center', padding: '40px', color: '#777', fontSize: '0.9rem'}}>
        &copy; {new Date().getFullYear()} Killeen Air Duct Cleaners. Serving Harker Heights, Killeen, and surrounding areas.
      </footer>
    </div>
  );
};
